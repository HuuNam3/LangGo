                ...
                <Card className="overflow-hidden">
                  ...
                  <div className="p-6">
                    ...
                    <div className="mb-6 rounded-lg bg-purple-50 p-4">
                      <h3 className="mb-2 text-lg font-semibold text-purple-800">About This course</h3>
                      <p className="text-gray-700">{course.introduction.description}</p>
                    </div>
                    ...
                    <div className="mb-6">
                      ...
                      <p className="text-gray-700">{course.introduction.prerequisites}</p>
                    </div>
