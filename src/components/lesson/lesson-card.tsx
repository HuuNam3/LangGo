...
export default function LessonCard() {
  ...
  return (
    ...
    <CollapsibleTrigger className="flex items-center justify-between w-full p-3 text-left hover:bg-gray-50 rounded-lg">
        <div>
        <div className="font-medium text-gray-800">Bài 1: Chào hỏi hàng ngày</div>
    ...
    <CollapsibleContent className="pl-4 space-y-1">
        ...
        <div className="flex-1">
            <div className="text-sm font-medium text-orange-700">1. Video bài giảng</div>
        ...
        <div className="flex-1">
            <div className="text-sm text-gray-700">2. Câu hỏi ôn tập sau video</div>
        ...
        <div className="flex-1">
            <div className="text-sm text-gray-700">3. Bài luyện từ vựng & phát âm</div>
        ...
        <div className="flex-1">
            <div className="text-sm text-gray-700">4. Bài tập tổng kết hoàn thành</div>
